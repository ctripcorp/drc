...
public class WatchKeyedTaskTest {
    ...
    public void testDoExecute() throws Throwable {
        ConcurrentHashMap<String, WatchActivity.LastLWM> lastLWMHashMap = new ConcurrentHashMap<>();
        WatchActivity.LastLWM lastLWM = new WatchActivity.LastLWM(1, 1, 1);
        ...
        MqServerContainer mockContainer = Mockito.mock(MqServerContainer.class);
