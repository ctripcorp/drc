...
public class MetaInfoServiceV2ImplTest {
    ...
    public void setup() throws SQLException {
        ...
        Mockito.when(dcTblDao.queryAll()).thenReturn(getAllDcs());
        Mockito.when(buTblDao.queryAll()).thenReturn(getAllBus());
        Mockito.when(regionTblDao.queryAll()).thenReturn(getRegions());
    }
