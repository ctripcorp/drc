 ...
 * @Date: 2021/4/25
 */
public class CurrentDstMetaManagerTest {

    @InjectMocks private CurrentDstMetaManager currentMetaManager;
    ...
    public void setUp() throws SQLException {
        ...
        Mockito.doReturn(monitorMetaInfo).when(cacheMetaService).getDstMonitorMetaInfo();
