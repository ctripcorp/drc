 ...
 * date: 2020-03-05
 */
public class CheckDbGtidTest {

    private CheckDbGtid checkGtid = new CheckDbGtid(new MockConfig());
    ...
    @Test
    public void testGetRepeatedGtidGap() {
        String uuid = "1e698014-90e5-11e9-a232-56d52b562abc";
        ...
        // first time
        Assert.assertEquals(0, checkGtid.getRepeatedGtidGap(gtidGapEntity, uuid,
                new GtidSet("1e698014-90e5-11e9-a232-56d52b562abc:1-2:5-7:9-10"),
                null));


        // no gap
        Assert.assertEquals(0, checkGtid.getRepeatedGtidGap(gtidGapEntity, uuid,
                new GtidSet("1e698014-90e5-11e9-a232-56d52b562abc:1-10"),
                new GtidSet("1e698014-90e5-11e9-a232-56d52b562abc:1-6")));
        ...
        // repeat
        Assert.assertEquals(2, checkGtid.getRepeatedGtidGap(gtidGapEntity, uuid,
                new GtidSet("1e698014-90e5-11e9-a232-56d52b562abc:1-2:5-6"),
                new GtidSet("1e698014-90e5-11e9-a232-56d52b562abc:1-2:5-6")));
    ...
    public void testGetGapIntervals() {
        ...
        List<GapInterval> expected1 = new LinkedList<>() {{
            add(new GapInterval(277006140L, 1878199779L));
        }};
        List<GapInterval> expected2 = new LinkedList<>();
        List<GapInterval> expected3 = new LinkedList<>();
    ...
    public void testGetRepeatedGapInterval() {
        ...
        List<GapInterval> curGapIntervals1 = new LinkedList<>() {{
            add(new GapInterval(277006140L, 277006999L));
        }};
        List<GapInterval> curGapIntervals2 = new LinkedList<>() {{
            add(new GapInterval(277006140L, 277006200L));
            add(new GapInterval(277006205L, 277006210L));
        }};
        List<GapInterval> curGapIntervals3 = new LinkedList<>() {{
            add(new GapInterval(277006140L, 277007005L));
        }};
        List<GapInterval> curGapIntervals4 = new LinkedList<>() {{
            add(new GapInterval(277007005L, 277007010L));
        }};
        ...
        List<GapInterval> expected4 = new LinkedList<>();
    ...
    public void testGetRepeatedGapIntervalHugeGap() {
        ...
        String uuid = "1e698014-90e5-11e9-a232-56d52b562cdd";
        List<GapInterval> curGapIntervals1 = new LinkedList<>() {{
            add(new GapInterval(10L, 277006999L));
        }};
    ...
    public void testGetRepeatedGapCount() {
        List<GapInterval> gapIntervals1 = new LinkedList<>() {{
            add(new GapInterval(277006140L, 277006999L));
        }};
        List<GapInterval> gapIntervals2 = new LinkedList<>() {{
            add(new GapInterval(277006140L, 277006200L));
            add(new GapInterval(277006205L, 277006210L));
        }};
        List<GapInterval> gapIntervals3 = new LinkedList<>() {{
            add(new GapInterval(277006140L, 277006999L));
        }};
        List<GapInterval> gapIntervals4 = new LinkedList<>();
