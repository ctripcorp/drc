...
public class ConflictTransactionLog {
    ...
    public ConflictTransactionLog() {
        this.rawSqlList = new ArrayList<>();
        this.rawSqlExecutedResultList = new ArrayList<>();
        this.destCurrentRecordList = new ArrayList<>();
        this.conflictHandleSqlList = new ArrayList<>();
        this.conflictHandleSqlExecutedResultList = new ArrayList<>();
    }
