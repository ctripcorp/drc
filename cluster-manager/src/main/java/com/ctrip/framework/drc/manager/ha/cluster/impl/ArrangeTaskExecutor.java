 ...
 */
@Component
public class ArrangeTaskExecutor extends AbstractLifecycle implements Runnable, TopElement {
    ...
    private void startTaskThread() {
        ...
        if(taskThread == null){
            taskThread = XpipeThreadFactory.create(
                    String.format("ArrangeTaskExecutor-(%s)", currentClusterServer.getServerId()) ).newThread(this);
            taskThread.start();
        }
    }
