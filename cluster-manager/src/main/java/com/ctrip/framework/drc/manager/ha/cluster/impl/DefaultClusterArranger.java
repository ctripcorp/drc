 ...
 */
@Component
public class DefaultClusterArranger extends AbstractLifecycle implements ClusterArranger, LeaderAware, Observer, TopElement {
    ...
    private void checkDeadServer() {
        Set<String> deadServer = new HashSet<>();


        Set<String> allSlotServers = slotManager.allServers();
        for(String slotServer : allSlotServers){
        ...
        if(deadServer.size() > 0){
            ...
            for(String deadServerId : deadServer){
