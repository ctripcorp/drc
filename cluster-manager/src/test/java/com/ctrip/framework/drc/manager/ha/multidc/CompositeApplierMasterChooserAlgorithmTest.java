 ...
 * @create 2021/12/17
 */
public class CompositeApplierMasterChooserAlgorithmTest extends AbstractDbClusterTest {

    private CompositeApplierMasterChooserAlgorithm configApplierMasterChooserAlgorithm;
    ...
    public void setUp() throws Exception {
        super.setUp();
        configApplierMasterChooserAlgorithm = new CompositeApplierMasterChooserAlgorithm(TARGET_DC, CLUSTER_ID, BACKUP_DAL_CLUSTER_ID, currentMetaManager, multiDcService, clusterManagerConfig, scheduledExecutorService);
    }
