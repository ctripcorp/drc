...
public class AllTests {
    ...
    public static void setUp() {
        try {
            ...
            wireMockServer.stubFor(post(urlPathMatching("/api/meta/clusterchange/integration-test.fxdrc/?dcId=test_dc_id&operator=test")).willReturn(okJson(Codec.DEFAULT.encode(ApiResult.getSuccessInstance(false)))));  //http://127.0.0.1:8080/api/meta/clusterchange/integration-test.fxdrc
            wireMockServer.stubFor(put(urlPathMatching("/api/meta/clusterchange/integration-test.fxdrc/?operator=test")).willReturn(okJson(Codec.DEFAULT.encode(ApiResult.getSuccessInstance(false)))));  //http://127.0.0.1:8080/api/meta/clusterchange/integration-test.fxdrc
            wireMockServer.stubFor(delete(urlPathMatching("/api/meta/clusterchange/integration-test.fxdrc/?operator=test")).willReturn(okJson(Codec.DEFAULT.encode(ApiResult.getSuccessInstance(false)))));  //http://127.0.0.1:8080/api/meta/clusterchange/integration-test.fxdrc
