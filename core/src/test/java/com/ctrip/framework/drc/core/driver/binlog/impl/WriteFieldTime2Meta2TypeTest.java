...
public class WriteFieldTime2Meta2TypeTest extends AbstractWriteFieldTypeTest {
    ...
    protected String getTableMapEventHexString() {
        return "43 57 84 62   13   ea 0c 00 00   31 00 00 00   26 39 00 00   00 00" +
                "72 00 00 00 00 00 01 00  04 64 72 63 31 00 05 74" +
                "69 6d 65 32 00 01 13 01  02 00 15 54 b1 5e";
    }
    ...
    protected TableMapLogEvent getDrcTableMapEvent() throws IOException {
        ...
        ArrayList<TableMapLogEvent.Column> sourceColumns = Lists.newArrayList(
                new TableMapLogEvent.Column("start_at", false, "time", null, null, null, "2", null, null, "time(2)", null, null, null)
        );
