...
import com.ctrip.framework.drc.core.driver.command.packet.Capability;
 ...
 * 2019/9/6 下午2:11.
 */
public class ClientAuthenticationPacket extends HeaderPacket {
    ...
    public byte[] toBytes() throws IOException {
        ...
        ByteHelper.writeUnsignedIntLittleEndian(MySQLConstants.MAX_PACKET_LENGTH, out);
...
//        super.write(byteBuf);  这样使用会有问题
    ...
    public String toString() {
        return "ClientAuthenticationPacket{" +
                ...
                ", scrumbleBuff=" + Arrays.toString(scrumbleBuff) +
