 ...
 * @create 2022/6/13
 */
public class RowsFilterEntity extends BaseEndpointEntity {
    ...
    public RowsFilterEntity(Builder builder) {
    ...
    public static final class Builder {
        ...
        public RowsFilterEntity build() {
            return new RowsFilterEntity(this);
        }
    }
    ...
    public void updateCount(long beforeCount, long afterCount) {
        total.addAndGet(beforeCount);
        send.addAndGet(afterCount);
    }
