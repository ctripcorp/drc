 ...
 * 2019/9/6 下午12:02.
 */
public class HandshakeInitializationPacket extends HeaderPacket {

    public byte protocolVersion = MySQLConstants.DEFAULT_PROTOCOL_VERSION;
    ...
    @Override
    public HandshakeInitializationPacket read(ByteBuf byteBuf) {
        super.read(byteBuf);
