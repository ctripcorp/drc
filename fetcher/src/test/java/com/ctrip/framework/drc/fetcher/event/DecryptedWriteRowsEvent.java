 ...
 * Oct 16, 2019
 */
public class DecryptedWriteRowsEvent extends MonitoredWriteRowsEvent {
    ...
    public static MonitoredWriteRowsEvent mockSimpleEvent() {
        final ByteBuf byteBuf = initMinimalRowsByteBuf();
        MonitoredWriteRowsEvent event = new MonitoredWriteRowsEvent();
        event.read(byteBuf);
