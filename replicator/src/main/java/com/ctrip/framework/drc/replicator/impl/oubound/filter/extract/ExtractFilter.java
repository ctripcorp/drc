...
public class ExtractFilter extends AbstractLogEventFilter<OutboundLogEventContext> {
    ...
    private void extractTableMapEvent(OutboundLogEventContext value, LogEventType eventType) {
    ...
    private void extractRowsEvent(OutboundLogEventContext value) {
    ...
    private TableMapLogEvent getRowsEventRelatedTableMapEvent(OutboundLogEventContext value) {
