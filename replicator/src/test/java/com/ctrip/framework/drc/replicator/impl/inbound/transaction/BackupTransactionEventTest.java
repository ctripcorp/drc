 ...
 * @create 2020/8/27
 */
public class BackupTransactionEventTest extends MockTest {
    ...
    public void testFalse() {
        //empty
        TransactionEvent transactionEvent = new BackupTransactionEvent();
        transactionEvent.write(ioCache);

        //first not gtid
        transactionEvent = new BackupTransactionEvent();
    ...
    public void testOneGtid() {
        ...
        transactionEvent.addLogEvent(gtidLogEvent);
        transactionEvent.write(ioCache);
        Assert.assertEquals(0, gtidLogEvent.getNextTransactionOffset());
    ...
    public void testOneGtidAndXid() {
        ...
        transactionEvent.addLogEvent(gtidLogEvent);
        transactionEvent.addLogEvent(xidLogEvent);
        long nextEventSize = gtidLogEvent.getLogEventHeader().getNextEventStartPosition();
        transactionEvent.write(ioCache);
        Assert.assertNotEquals(nextEventSize, gtidLogEvent.getNextTransactionOffset());
        Assert.assertEquals(0, gtidLogEvent.getNextTransactionOffset());
