 ...
 * 2025/7/21 16:35
 */
public class DdlParserV2Test {

    @Test
    public void testCreate() {
        String queryString = "CREATE TABLE test_table ( `ID` int(11) )";
        DdlResult result = DdlParserV2.parse(queryString, "test_db").get(0);
        ...
        result = DdlParserV2.parse(queryString, "test_db").get(0);
        Assert.assertNotNull(result);
        Assert.assertEquals("test_db", result.getSchemaName());
        Assert.assertEquals("test_table", result.getTableName());
        ...
        result = DdlParserV2.parse(queryString, "bak").get(0);
        Assert.assertNotNull(result);
    ...
    public void testDrop() {
        ...
        result = DdlParserV2.parse(queryString, "test").get(0);
        Assert.assertNotNull(result);
        Assert.assertEquals("test_db", result.getSchemaName());
        Assert.assertEquals("test_table", result.getTableName());
        result = DdlParserV2.parse(queryString, "test").get(1);
        Assert.assertNotNull(result);
        Assert.assertEquals("test", result.getSchemaName());
    ...
    public void testAlert() {
        ...
        result = DdlParserV2.parse(queryString, "test_db").get(1);
        Assert.assertNotNull(result);
        Assert.assertEquals("test_table", result.getTableName());
        ...
        // test schemaName
        queryString = "alter table  test_db.`test_table` drop index emp_name;";
        result = DdlParserV2.parse(queryString, "test_db3").get(0);
        Assert.assertNotNull(result);
        Assert.assertEquals("test_table", result.getTableName());
        Assert.assertEquals("test_db", result.getSchemaName());
        ...
        queryString = "alter table  test_db.`test_table` drop index emp_name;";
        result = DdlParserV2.parse(queryString, null).get(0);
        Assert.assertNotNull(result);
        Assert.assertEquals("test_table", result.getTableName());
        Assert.assertEquals("test_db", result.getSchemaName());
    }
    ...
    public void testRename() {
        ...
        result = DdlParserV2.parse(queryString, "ghostdb").get(0);
        Assert.assertNotNull(result);
        ...
        result = DdlParserV2.parse(queryString, "ghostdb").get(1);
        Assert.assertNotNull(result);
        Assert.assertEquals("ghostdb", result.getOriSchemaName());
        Assert.assertEquals("ghostdb", result.getSchemaName());
    ...
    public void testDb() {
        ...
        DdlResult result = DdlParserV2.parse(queryString, "db0").get(0);
        Assert.assertNotNull(result);
    ...
    public void testWrongSchema() {
        String queryString = "CREATE TABLE drc1.test_identity (" +
                ...
                "PRIMARY KEY (`id`)" +
                ");";
        DdlResult result = DdlParserV2.parse(queryString, "drc4").get(0);
        Assert.assertNotNull(result);
    ...
    public void test() {
        ...
        DdlResult ddlResult = DdlParserV2.parse(queryString, "tourorderresourceshard05db").get(0);
    ...
    private void parseDdl(String queryString, String db) {
        DdlResult ddlResult = DdlParserV2.parse(queryString, db).get(0);
