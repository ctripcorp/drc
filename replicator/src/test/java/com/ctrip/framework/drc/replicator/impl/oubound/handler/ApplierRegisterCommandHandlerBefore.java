 ...
 * 2019/9/21 10:13
 */
public class ApplierRegisterCommandHandlerBefore extends AbstractServerCommandHandler implements CommandHandler {
    ...
    public ApplierRegisterCommandHandlerBefore(GtidManager gtidManager, FileManager fileManager, OutboundMonitorReport outboundMonitorReport, ReplicatorConfig replicatorConfig) {
    ...
    List<DumpTask> list = new ArrayList<>();

    public List<DumpTask> getList() {
        return list;
    }
    ...
    public class DumpTask implements Runnable, GtidObserver {
        ...
        public DumpTask(Channel channel, ApplierDumpCommandPacket dumpCommandPacket, String ip) throws Exception {
            ...
            filterChain = new OutboundFilterChainFactory().createFilterChain(
                    OutboundFilterChainFactory.OutboundFilterChainContext.from(
                            this.applierName,
                            this.channel,
                            this.consumeType,
                            dataMediaConfig,
