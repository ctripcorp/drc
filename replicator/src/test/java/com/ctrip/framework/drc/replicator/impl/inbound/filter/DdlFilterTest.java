...
public class DdlFilterTest extends MockTest {
    ...
    public void setUp() {
        super.initMocks();
        when(schemaManager.apply(anyString(), anyString(), anyString())).thenReturn(true);
    ...
    public void testCreateCharset() {
        ...
        Assert.assertFalse(ddlFilter.parseQueryEvent(queryLogEvent, gtid));
        verify(schemaManager, times(1)).apply("ghostdb", CREATE_TABLE, gtid);
        ...
        Assert.assertTrue(ddlFilter.parseQueryEvent(queryLogEvent, gtid));
        verify(schemaManager, times(1)).apply("test1", CREATE_TABLE, gtid);
        ...
        when(queryStatus.getServerCollation()).thenReturn(33);  //utf8
        Assert.assertTrue(ddlFilter.parseQueryEvent(queryLogEvent, gtid));
        verify(schemaManager, times(1)).apply("test1", MODIFIED_CREATE_TABLE, gtid);
    ...
    public void testWrongNameLogEvent() {
        ...
        Assert.assertTrue(ddlFilter.parseQueryEvent(queryLogEvent, gtid));
        verify(schemaManager, times(1)).apply(dbName, CREATE_TABLE, gtid);
