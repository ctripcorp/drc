...
public class DdlFilterTest extends MockTest {
    ...
    public void testRenameDdl() {
        ...
        when(schemaManager.apply(anyString(), anyString(), any(QueryType.class))).thenReturn(ApplyResult.from(ApplyResult.Status.SUCCESS, RENAME_DDL));
    ...
    public void testAlterTablePartition() {
        ...
        when(schemaManager.find(schemaName, tableName)).thenReturn(tableInfo);
        when(schemaManager.apply(schemaName, DDL, QueryType.CREATE)).thenReturn(ApplyResult.from(ApplyResult.Status.PARTITION_SKIP, DDL));
    ...
    public void testCreateTablePartition() {
        ...
        when(queryLogEvent.getSchemaName()).thenReturn(schemaName);
        when(schemaManager.find(schemaName, tableName)).thenReturn(tableInfo);
        when(schemaManager.apply(schemaName, DDL, QueryType.CREATE)).thenReturn(ApplyResult.from(ApplyResult.Status.SUCCESS, DDL));
