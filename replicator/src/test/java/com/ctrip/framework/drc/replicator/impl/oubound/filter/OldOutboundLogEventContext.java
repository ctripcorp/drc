 ...
 * @create 2022/4/22
 */
public class OldOutboundLogEventContext{
    ...
    public OldOutboundLogEventContext() {
    }

    public OldOutboundLogEventContext(FileChannel fileChannel, long fileChannelPos, long fileChannelSize) {
